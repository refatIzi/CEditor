...
public class Visualization {
    ...
    final private TextColor similar_part_of_speeches = new TextColor(
            Pattern.compile(
                    "\\b(were made|who merely stated|The government|stricter about|hose receiving benefits|verification of address)\\b"),
    ...
    private TextColor DETECT_WORD = new TextColor(
            Pattern.compile("\\b(loans|borrowers|income|independent|become|without)\\b"),
            Color.parseColor("#648cb8")
    );
